...
int setupTCPServer()
{
    ...
    //////////////////////////////////////////////////
    // CHANGE PORT IF ALREADY IN USE, OR KILL PROCESS (SEE NOTES IN .TXT)
    //
...
//  meth = (SSL_METHOD *)TLSv1_2_method(); // Deprecated
  meth = (const SSL_METHOD *)TLS_method();
  ctx = SSL_CTX_new(meth);
  SSL_CTX_set_verify(ctx, SSL_VERIFY_NONE, NULL); // Do not verify client certificate
